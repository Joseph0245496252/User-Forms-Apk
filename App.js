    ...
    <View style={styles.container}>
      <View style={styles.imageView}>
        ...
        <View style={styles.details}>
            ...
            <Text>freecoding1@gmail.com</Text>
            <Text style={[styles.itemSpace,styles.textwithcolor]}>Name</Text>
            <TextInput defaultValue="Joseph Asante"  style={styles.underline}/>
            <Text style={[styles.itemSpace,styles.textwithcolor]}>Nick Name</Text>
            <TextInput defaultValue="Reppy"  style={styles.underline}/>
            <Text style={[styles.itemSpace,styles.textwithcolor]}>Emergency Contact</Text>
            <TextInput defaultValue="+233245496252" style={styles.underline}/>
